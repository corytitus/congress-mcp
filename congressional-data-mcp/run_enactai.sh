#!/bin/bash
# EnactAI Data MCP Server Runner
...
exec /opt/homebrew/bin/python3 /Users/corytitus/Documents/GitHub/congress-mcp/congressional-data-mcp/enactai_server_enhanced.py